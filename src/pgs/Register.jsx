...
export function Register() {
  return (
    <section
      ...
      className="w-full m-20 flex flex-row justify-center items-center"
    >
      <div className="pattern-img">
        <img
          style={{ maxWidth: "", height: "75vh", borderRadius: "2rem" }}
          src={pattern}
          className="basis-1/2 h-full w-full object-cover rounded-3xl"
        />
      </div>
      <div
        style={{
      ...
      >
        <div className="text-center">
          <Typography variant="h2" className="text-green-700 font-bold mb-4">
            Join Us Today
          </Typography>
          <Typography
            variant="paragraph"
        ...
        <form className="mt-6 mb-2 mx-auto w-80 max-w-screen-lg lg:w-1/2">
          ...
          />
          <div style={{ rowGap: "1rem" }} className="mt-8 flex flex-col">
            <Button
